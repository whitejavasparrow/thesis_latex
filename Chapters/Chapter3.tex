...
A dependency parser for classical Chinese is released based on historical corpus of Four Books (四書) \parencite{yasuoka2019universal}, with dictionary-based tokenizer and POS taggers\footnote{\url{https://pypi.org/project/udkanbun/}}. In this study, character-based embeddings are generated, and building upon the character-based embeddings, the results can serve as comparison basis with token-based ones.
