...
Firstly, Sense 1 and Sense 3 comprise the highest proportions in the 1980s. This prevalence stems from the rapid growth of use of the two senses. Nonetheless, the evolvement of Sense 3 is unstable to a certain degree, which is possibly because of the distinguishment from a similar sense, Sense 2, as in \exref{ex:settle_down}, and the misclassification of \zh{國[家]}{guójiā}{country; state} into both Sense 2 and 3, as in \exref{ex:country}. In contrast, the upward curve of Sense 1 is sharpe, which embodies the clear context conveying the meaning of \jia as a physical entity, as in \exref{ex:house_Tang} for pre-modern Chinese and \exref{ex:house_1980s} for modern Chinese.
...
\begin{exe}
  ...
  \ex{
    ...
    {You will often hear the chirping insects near your house making sounds.}%
    {1980s}{\gls{asbc}}
...
In modern Chinese, Sense 7, 8, 9 are profession-related senses, as in \zh{美聲[家]}{měishēngjiā}{bel canto singer}, \zh{樵[家]和獵[家]}{qiáojiā hàn lièjiā}{woodman and hunter}, \zh{儒墨兩[家]}{rúmòliǎngjiā}{the Confucian and Mohist schools}. Despite being semantically similar, only Sense 8 and 9 evolve cooperatively, whereas Sense 7 is seen to compete against these two senses. Both Sense 8 and Sense 9 stably decrease, while Sense 7 surges approximately starting from the Qing dynasty and continues to be more and more prominent in the 1980s. Professions like \zh{醫[家]}{yījiā}{doctor}, \zh{史[家]}{shǐjiā}{historian}, and \zh{詩[家]}{shījiā}{poet} from \exref{ex:doctor} through \exref{ex:poet} are accurately mapped to Sense 7 in pre-modern Chinese, and a wide variety of occupations are included for the same sense in modern Chinese, which contributes to the rise and prominence of Sense 7 in the 1980s.
