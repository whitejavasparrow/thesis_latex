...
% cS[table-format=3]S[table-format=7,group-separator={,},group-minimum-digits=3]S[table-format=4,group-separator={,},group-minimum-digits=3]cc,head to column names
\begin{table}[H]
\centering
