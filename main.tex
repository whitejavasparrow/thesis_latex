...
\begin{document}
    ...
    \AtPageUpperRight{\raisebox{-2.5cm-\height}{{\horizontalmove{-2.5cm}{\includegraphics[scale=0.5]{figures/watermark.png}}}}}} % move left and down by 2.5m, 0.5 of photo size
